...
export function SkillsCard({ title, skills, animClass = 'ar d1', scrollable = false, collapsible, defaultCollapsed, xpAvailable }: SkillsCardProps) {
          ...
          return (
            <div key={i} style={{
              ...
              <span style={{
                ...
                color: sk.isCareer ? '#d64d8a' : 'var(--txt)',
              }}>
                {sk.name}
              </span>
              <span style={{
